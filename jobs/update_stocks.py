...
def update_stocks(context):
    ...
    try:
        response = requests.get(api_endpoint, params={
            "access_key":api_key, "symbols":symbols, "date_from":date_from, "date_to":date_to
        })
...
def parse_stocks_response(response):
    ...
    for content in data:
        ...
        recorded_content = {"open":content['open'], "high":content['high'], "low": content['low'], "close":content['close'], "volume":content['volume'] }
